...
use gpui::{
    actions, div, fill, hsla, point, prelude::*, px, relative, rgb, rgba, size, App, AppContext, Bounds, ClipboardItem, Context, CursorStyle, ElementId,
    ElementInputHandler, Entity, EntityInputHandler, FocusHandle, Focusable, GlobalElementId,
    KeyBinding, LayoutId, MouseButton, MouseDownEvent, MouseMoveEvent, MouseUpEvent,
...
impl TextInputComponent {
    ...
    pub fn change_content(&mut self, text: SharedString) {
        self.content = text;
    }
...
pub fn setup_input_keyboards(cx: &mut App) {
    cx.bind_keys([
