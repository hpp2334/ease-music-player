...
#[derive(
    Debug, Serialize, Deserialize, Clone, Hash, PartialEq, Eq, uniffi::Record, PartialOrd, Ord,
)]
...
#[derive(
    Clone, Copy, Debug, PartialEq, Eq, Default, Hash, Serialize, Deserialize, uniffi::Enum,
)]
