...
import com.kutedev.easemusicplayer.platform.decodeImageBitmap
import uniffi.ease_client_backend.ctGetAsset
import uniffi.ease_client_backend.easeError
import uniffi.ease_client_schema.DataSourceKey

class AssetRepository constructor(private val bridge: Bridge) {
    ...
    suspend fun loadBitmap(key: DataSourceKey): ImageBitmap? {
        ...
        val bitmap = decodeImageBitmap(buf) ?: return null
